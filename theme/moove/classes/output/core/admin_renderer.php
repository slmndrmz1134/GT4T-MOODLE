...
class admin_renderer extends \core_admin_renderer {
    ...
    /**
     * Overrides the Moodle core copyright block for the custom GT4T build.
     *
     * @return string HTML copyright block.
     */
    protected function moodle_copyright() {
        $copyrighttext = '<strong>GT4T Custom Moodle Build</strong><br />' .
                         'Copyright &copy; 2026 GT4T Hub. All rights reserved.';
        return $this->box($copyrighttext, 'copyright text-center');
    }
}
