...
// GT4T front page navigation & footer.
$string['gt4tnavhome'] = 'Home';
$string['gt4tnavfeatures'] = 'Features';
$string['gt4tnavcollaborate'] = 'Collaborators';
$string['gt4tnavimpact'] = 'Impact';
$string['gt4tnavfaq'] = 'FAQ';
$string['gt4tfootertagline'] = 'Green and digital transition through higher education, industry, and innovation ecosystems.';
$string['gt4tfooterexplore'] = 'Explore';
$string['gt4tfootercourses'] = 'Courses';
$string['gt4tfooterlogin'] = 'Log in';
$string['gt4tloginsubtitle'] = 'Enter your username and password to access your account.';
$string['gt4tloginsignupbtn'] = 'Create new account';
$string['gt4tsignupsubtitle'] = 'Choose your university, then complete the form to create your account.';
$string['signuptenant'] = 'University';
$string['signuptenantchoose'] = 'Select your university…';
$string['signuptenant_help'] = 'Your account will be created for the university you select. You cannot change this later without administrator help.';
$string['signuptenantinvalid'] = 'Please select a valid university.';
$string['signupsitenotavailable'] = 'Account creation is not available. No university on this site currently allows new registrations. Please contact your institution or site administrator.';
$string['alreadyhaveaccount'] = 'Already have an account? Log in';
$string['gt4tfooternav'] = 'On this page';
$string['gt4tfootercopyright'] = '© {$a} GreenTech4Transformation. All rights reserved.';
