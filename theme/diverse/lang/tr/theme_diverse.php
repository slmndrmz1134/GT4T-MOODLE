...
$string['landing_intro'] = 'DIVERSE Avrupa Üniversitesi Birliği; Avrupa genelinde ortak üniversiteleri, sanayiyi ve inovasyon ekosistemlerini birbirine bağlar.';
...
$string['stat_users'] = 'Kayıtlı kullanıcı';
$string['collab_eyebrow'] = 'Nasıl iş birliği yapıyoruz';
$string['collab_title'] = 'Ortak eğitimler ve uygulamalı inovasyon projeleri';
$string['collab_intro'] = 'Ortak üniversiteler ortak eğitimler ve uygulamalı inovasyon projeleri sunar. Karma ve sınır ötesi ekipler, şirketlerden ve bölgesel ekosistemlerden gelen gerçek zorluklar üzerinde şu alanları birleştirerek çalışır:';
$string['collab_item1'] = 'İnovasyon metodolojileri';
$string['collab_item2'] = 'Fikir doğrulama';
$string['collab_item3'] = 'Değer önerisi geliştirme';
$string['collab_item4'] = 'Pitching (sunum) hazırlığı';
$string['collab_item5'] = 'Erken aşama ticarileştirme farkındalığı';
$string['collab_outro'] = 'DIVERSE; paylaşılan eğitim formatları, ortak araç kitleri ve metodolojiler ile aktarılabilir uygulama yaklaşımlarını içeren tekrarlanabilir iş birliği modelleri üretir.';
$string['impact_eyebrow'] = 'Uzun vadeli etki';
$string['impact_title'] = 'Kalıcı iş birliği';
$string['impact_intro'] = 'DIVERSE; pilot uygulamalar, sınır ötesi araştırma-sektör bağlantıları ve sistematik girişimcilik eğitimiyle üniversiteler ve ekosistemler arasında yapılandırılmış iş birliğini teşvik eder.';
$string['impact_item1_title'] = 'Pilotlar ve Kavram Kanıtları';
$string['impact_item1_desc'] = 'Sektör ve bölgesel ortaklarla sürdürülebilir çözümleri test etme ve doğrulama.';
$string['impact_item2_title'] = 'Araştırmadan Sektöre';
$string['impact_item2_desc'] = 'Akademik araştırmayı gerçek dünyada etkiye dönüştüren sınır ötesi bağlantılar.';
$string['impact_item3_title'] = 'Venture Science Center';
$string['impact_item3_desc'] = 'Eğitim, prototipleme ve ekosistem katılımı için kalıcı merkezler; uzun vadeli etki ve ölçeklenebilirlik sağlar.';
$string['partners_eyebrow'] = 'Ortaklar';
$string['partners_title'] = 'Ortak üniversiteler';
$string['partners_intro'] = 'Her üniversite kendi derslerini sunar. Ortak dersler tüm ortakların öğrencilerine açıktır.';
$string['partners_courses'] = '{$a} ders';
$string['partners_login'] = 'Giriş yap';
