 ...
 */
final class create_tenant extends external_api {
    /**
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'tenant' => new external_single_structure([
                'name' => new external_value(PARAM_TEXT, 'mame'),
                ...
                'assoccohortcreate' => new external_value(PARAM_BOOL, 'create associated cohort', VALUE_OPTIONAL),
            ]),
        ]);
    }
    ...
    public static function execute(array $tenant): array {
        ...
        return (array)\tool_mutenancy\local\tenant::create((object)$tenant);
    }
