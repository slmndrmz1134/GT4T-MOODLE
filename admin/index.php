...
// Intercept unauthorized requests to redirect to the dedicated admin login
if (!isloggedin() || isguestuser()) {
    $SESSION->wantsurl = (string)new moodle_url('/admin/index.php');
    redirect(new moodle_url('/admin/login.php'));
}

$context = context_system::instance();
if (!has_capability('moodle/site:config', $context)) {
    // If logged in as a normal user (e.g. Student/Academician), log them out and direct to admin login
    require_logout();
    $SESSION->wantsurl = (string)new moodle_url('/admin/index.php');
    redirect(new moodle_url('/admin/login.php', array('error' => 'notadmin')));
}
