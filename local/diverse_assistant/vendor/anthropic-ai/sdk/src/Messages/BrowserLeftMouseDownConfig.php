 ...
 *
 * @phpstan-type BrowserLeftMouseDownConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BrowserLeftMouseDownConfig implements BaseModel
{
    /** @use SdkModel<BrowserLeftMouseDownConfigShape> */
    use SdkModel;
