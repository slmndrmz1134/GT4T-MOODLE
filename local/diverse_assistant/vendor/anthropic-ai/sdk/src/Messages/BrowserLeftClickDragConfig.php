 ...
 *
 * @phpstan-type BrowserLeftClickDragConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BrowserLeftClickDragConfig implements BaseModel
{
    /** @use SdkModel<BrowserLeftClickDragConfigShape> */
    use SdkModel;
