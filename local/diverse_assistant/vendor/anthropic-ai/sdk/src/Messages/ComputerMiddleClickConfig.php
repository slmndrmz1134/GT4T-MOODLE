 ...
 *
 * @phpstan-type ComputerMiddleClickConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class ComputerMiddleClickConfig implements BaseModel
{
    /** @use SdkModel<ComputerMiddleClickConfigShape> */
    use SdkModel;
