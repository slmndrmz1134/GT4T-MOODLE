 ...
 *
 * @phpstan-type BrowserStateTabEntryShape = array{
 *   tabID: string, title: string, url: string, active?: bool|null
 * }
 */
final class BrowserStateTabEntry implements BaseModel
{
    /** @use SdkModel<BrowserStateTabEntryShape> */
    use SdkModel;
    ...
    /**
     * `new BrowserStateTabEntry()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrowserStateTabEntry::with(tabID: ..., title: ..., url: ...)
     * ```
     *
