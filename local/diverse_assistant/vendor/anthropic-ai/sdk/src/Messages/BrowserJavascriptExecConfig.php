 ...
 *
 * @phpstan-type BrowserJavascriptExecConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BrowserJavascriptExecConfig implements BaseModel
{
    /** @use SdkModel<BrowserJavascriptExecConfigShape> */
    use SdkModel;
