...
use Anthropic\Beta\Sessions\BetaManagedAgentsServerToolUsage;
 ...
 *
 * @phpstan-type ManagedAgentsSessionUsageSnapshotShape = array{
 ...
 * }
 */
final class ManagedAgentsSessionUsageSnapshot implements BaseModel
{
    /** @use SdkModel<ManagedAgentsSessionUsageSnapshotShape> */
    use SdkModel;
     ...
     */
    public function withListCost(BetaMonetaryAmount|array $listCost): self
    {
        $self = clone $this;
    ...
    public function withServerToolUse(
        BetaManagedAgentsServerToolUsage|array $serverToolUse
    ): self {
        $self = clone $this;
