 ...
 *
 * @phpstan-type BetaBrowserListTabsConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserListTabsConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserListTabsConfigShape> */
    use SdkModel;
