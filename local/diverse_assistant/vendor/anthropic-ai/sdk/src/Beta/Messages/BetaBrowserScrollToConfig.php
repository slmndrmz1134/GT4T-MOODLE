 ...
 *
 * @phpstan-type BetaBrowserScrollToConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserScrollToConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserScrollToConfigShape> */
    use SdkModel;
