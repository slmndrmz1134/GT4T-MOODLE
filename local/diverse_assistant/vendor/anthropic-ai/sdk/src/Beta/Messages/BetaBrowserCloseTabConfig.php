 ...
 *
 * @phpstan-type BetaBrowserCloseTabConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserCloseTabConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserCloseTabConfigShape> */
    use SdkModel;
