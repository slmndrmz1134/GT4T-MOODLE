 ...
 *
 * @phpstan-type BetaComputerHoldKeyConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaComputerHoldKeyConfig implements BaseModel
{
    /** @use SdkModel<BetaComputerHoldKeyConfigShape> */
    use SdkModel;
