 ...
 *
 * @phpstan-type BetaBrowserDoubleClickConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserDoubleClickConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserDoubleClickConfigShape> */
    use SdkModel;
