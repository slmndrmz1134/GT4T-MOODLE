 ...
 *
 * @phpstan-type BetaBrowserScreenshotConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserScreenshotConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserScreenshotConfigShape> */
    use SdkModel;
