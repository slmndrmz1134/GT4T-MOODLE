 ...
 *
 * @phpstan-type BetaBrowserFileUploadConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserFileUploadConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserFileUploadConfigShape> */
    use SdkModel;
