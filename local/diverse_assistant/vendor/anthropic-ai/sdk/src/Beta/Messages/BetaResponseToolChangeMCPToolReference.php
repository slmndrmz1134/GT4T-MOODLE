 ...
 *
 * @phpstan-type BetaResponseToolChangeMCPToolReferenceShape = array{
 *   name: string, serverName: string, type: 'mcp_tool_reference'
 * }
 */
final class BetaResponseToolChangeMCPToolReference implements BaseModel
{
    /** @use SdkModel<BetaResponseToolChangeMCPToolReferenceShape> */
    use SdkModel;
    ...
    /**
     * `new BetaResponseToolChangeMCPToolReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BetaResponseToolChangeMCPToolReference::with(name: ..., serverName: ...)
     * ```
     *
