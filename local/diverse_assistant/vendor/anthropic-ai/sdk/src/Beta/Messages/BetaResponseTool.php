...
use Anthropic\Beta\Messages\BetaResponseTool\AllowedCaller;
use Anthropic\Beta\Messages\BetaResponseTool\Type;
 ...
 *
 * @phpstan-import-type BetaResponseToolInputSchemaShape from \Anthropic\Beta\Messages\BetaResponseToolInputSchema
 *
 * @phpstan-type BetaResponseToolShape = array{
 *   inputSchema: BetaResponseToolInputSchema|BetaResponseToolInputSchemaShape,
 *   name: string,
 ...
 * }
 */
final class BetaResponseTool implements BaseModel
{
    /** @use SdkModel<BetaResponseToolShape> */
    use SdkModel;
    ...
    public BetaResponseToolInputSchema $inputSchema;
    ...
    /**
     * `new BetaResponseTool()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BetaResponseTool::with(inputSchema: ..., name: ...)
     * ```
     *
     ...
     *
     * @param BetaResponseToolInputSchema|BetaResponseToolInputSchemaShape $inputSchema
    ...
    public static function with(
        BetaResponseToolInputSchema|array $inputSchema,
        string $name,
