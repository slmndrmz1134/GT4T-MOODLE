 ...
 *
 * @phpstan-type BetaBrowserMiddleClickConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserMiddleClickConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserMiddleClickConfigShape> */
    use SdkModel;
