 ...
 *
 * @phpstan-type BetaBrowserLeftClickConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserLeftClickConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserLeftClickConfigShape> */
    use SdkModel;
