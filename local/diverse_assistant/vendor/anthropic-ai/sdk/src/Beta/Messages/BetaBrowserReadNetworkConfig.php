 ...
 *
 * @phpstan-type BetaBrowserReadNetworkConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserReadNetworkConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserReadNetworkConfigShape> */
    use SdkModel;
