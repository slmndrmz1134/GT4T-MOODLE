 ...
 *
 * @phpstan-type BetaBrowserLeftMouseUpConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserLeftMouseUpConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserLeftMouseUpConfigShape> */
    use SdkModel;
