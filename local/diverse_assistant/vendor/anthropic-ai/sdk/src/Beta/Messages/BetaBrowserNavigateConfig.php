 ...
 *
 * @phpstan-type BetaBrowserNavigateConfigShape = array{
 *   deferLoading?: bool|null, enabled?: bool|null
 * }
 */
final class BetaBrowserNavigateConfig implements BaseModel
{
    /** @use SdkModel<BetaBrowserNavigateConfigShape> */
    use SdkModel;
